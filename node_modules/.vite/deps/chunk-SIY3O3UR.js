...
var Filler = React11.forwardRef(function(_ref, ref) {
...
function Item(_ref) {
  ...
  var refFunc = React12.useCallback(function(node) {
    setRef(node);
  }, []);
...
function useChildren(list, startIndex, endIndex, scrollWidth, setNodeRef, renderFunc, _ref) {
  ...
  return list.slice(startIndex, endIndex + 1).map(function(item, index2) {
    ...
    var key = getKey(item);
    return React13.createElement(Item, {
      key,
...
function useDiffItem(data, getKey, onDiff) {
  var _React$useState = React14.useState(data), _React$useState2 = _slicedToArray(_React$useState, 2), prevData = _React$useState2[0], setPrevData = _React$useState2[1];
  var _React$useState3 = React14.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), diffItem = _React$useState4[0], setDiffItem = _React$useState4[1];
...
function useHeights(getKey, onItemAdd, onItemRemove) {
  var _React$useState = React16.useState(0), _React$useState2 = _slicedToArray(_React$useState, 2), updatedMark = _React$useState2[0], setUpdatedMark = _React$useState2[1];
...
function useScrollTo(containerRef, data, heights, itemHeight, getKey, collectHeight, syncScrollTop, triggerFlash) {
  var scrollRef = React17.useRef();
  var _React$useState = React17.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), syncState = _React$useState2[0], setSyncState = _React$useState2[1];
  useLayoutEffect_default(function() {
...
var ScrollBar = React18.forwardRef(function(props, ref) {
  ...
  var _React$useState = React18.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), dragging = _React$useState2[0], setDragging = _React$useState2[1];
  var _React$useState3 = React18.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), pageXY = _React$useState4[0], setPageXY = _React$useState4[1];
  var _React$useState5 = React18.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), startTop = _React$useState6[0], setStartTop = _React$useState6[1];
  var isLTR = !rtl;
  var scrollbarRef = React18.useRef();
  var thumbRef = React18.useRef();
  var _React$useState7 = React18.useState(false), _React$useState8 = _slicedToArray(_React$useState7, 2), visible = _React$useState8[0], setVisible = _React$useState8[1];
  var visibleTimeoutRef = React18.useRef();
  ...
  var top = React18.useMemo(function() {
  ...
  var enableScrollRangeRef = React18.useRef();
  enableScrollRangeRef.current = enableScrollRange;
  var enableOffsetRangeRef = React18.useRef();
...
function RawList(props, ref) {
  ...
  var getKey = React19.useCallback(function(item) {
  ...
  var containerHeight = React19.useMemo(function() {
  ...
  var _React$useMemo = React19.useMemo(function() {
    if (!useVirtual) {
      return {
        scrollHeight: void 0,
        start: 0,
  ...
  var horizontalScrollBarSpinSize = React19.useMemo(function() {
    return getSpinSize(size.width, scrollWidth);
  }, [size.width, scrollWidth]);
  var verticalScrollBarSpinSize = React19.useMemo(function() {
  ...
  return React19.createElement("div", _extends({
  ...
  }, containerProps, restProps), React19.createElement(es_default, {
    onResize: onHolderResize
  }, React19.createElement(Component2, {
    className: "".concat(prefixCls, "-holder"),
    style: componentStyle,
    ref: componentRef,
    onScroll: onFallbackScroll,
    onMouseEnter: delayHideScrollBar
  }, React19.createElement(Filler_default, {
    prefixCls,
    height: scrollHeight,
    offsetX: offsetLeft,
    offsetY: fillerOffset,
    ...
    rtl: isRTL,
    extra: extraContent
  }, listChildren))), inVirtual && scrollHeight > height && React19.createElement(ScrollBar_default, {
  ...
  }), inVirtual && scrollWidth > size.width && React19.createElement(ScrollBar_default, {
...
var List = React19.forwardRef(RawList);
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SIY3O3UR.js.map
